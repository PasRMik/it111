...
//        hourWithOvertime = total / (regHours + overtimeHours);
//
...
//        System.out.println("Hourly rate with overtime: $"  +hourWithOvertime+ " dollars");
//        System.out.printf("Hourly rate with overtime: ");
//        System.out.printf("$%.2f", hourWithOvertime);
